...
const inputClasses =
'mt-2 w-full rounded-xl border border-zinc-300 bg-zinc-100 px-4 py3 text sm text-zince-900 outline-none transition placeholder:text-zinc-400 focus:border-zinc-900 focus:bg-zinc-50';
    ...
    return (
        ...
        <form className="mt-8 space-y-5">
            ...
            <div>
                ...
                <p className="mt-2-2 text-xs leading-5 text-zinc-500">
            ...
            <div className="grid gap-3 pt-3 pt-2 sm:grid-cols">
